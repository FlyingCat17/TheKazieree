 ...
 * @author LenataHoma
 */
public class formTambahProdukBarang extends javax.swing.JDialog {
int x, y;
    /**
     * Creates new form formTambahProdukBarang
     */
    public formTambahProdukBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        Mainhome mn = new Mainhome();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formTambahProdukBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formTambahProdukBarang dialog = new formTambahProdukBarang(new javax.swing.JFrame(), true);
