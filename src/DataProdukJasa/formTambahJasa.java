 ...
 * @author LenataHoma
 */
public class formTambahJasa extends javax.swing.JDialog {
int x, y;
    /**
     * Creates new form formTambahJasa
     */
    public formTambahJasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_kodeProduk, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 133, 360, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DataProdukJasa/form_tambahProdukJasa (1).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formTambahJasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formTambahJasa dialog = new formTambahJasa(new javax.swing.JFrame(), true);
